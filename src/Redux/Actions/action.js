...
const API_KEY = "f99440dca1ba7da268636d1b51c7f4e"
...
export const fetchUpcomingMusic = () => (dispatch) => {
    ...
    .then(res => dispatch({ type: FETCH_UPCOMING_MOVIES, payload: res}))
...
export const makeMovieSearch = data => dispatch => {
    ...
    .then(response => dispatch({ type: FETCH_SEARCH_SUCCESS, payload: response}))
